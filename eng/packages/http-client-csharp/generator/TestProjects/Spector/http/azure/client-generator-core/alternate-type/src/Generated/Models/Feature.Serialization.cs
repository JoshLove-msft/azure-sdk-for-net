...
namespace Specs.Azure.ClientGenerator.Core.AlternateType._ExternalType
{
    public partial class Feature : IJsonModel<Feature>
    {
        ...
        /// <param name="feature"> The <see cref="Feature"/> to serialize into <see cref="global::Azure.Core.RequestContent"/>. </param>
        public static implicit operator global::Azure.Core.RequestContent(Feature feature) => throw null;

        public static explicit operator Feature(global::Azure.Response response) => throw null;
