...
namespace Azure.AI.Agents.Persistent
{
    ...
    public partial class VectorStoreFileBatch : IJsonModel<VectorStoreFileBatch>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="VectorStoreFileBatch"/> from. </param>
        public static explicit operator VectorStoreFileBatch(Response response)
        {
