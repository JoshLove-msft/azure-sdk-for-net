...
namespace Azure.AI.Agents.Persistent.Telemetry
{
    ...
    internal class OpenTelemetryScope : IDisposable
    {
        ...
        private static CreateAgentRequest DeserializeCreateAgentRequest(RequestContent content)
        {
            ...
            return CreateAgentRequest.DeserializeCreateAgentRequest(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        private static CreateMessageRequest DeserializeCreateMessageRequest(RequestContent content)
        {
            ...
            using var document = JsonDocument.Parse(stream);
            return CreateMessageRequest.DeserializeCreateMessageRequest(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        private static CreateRunRequest DeserializeCreateRunRequest(RequestContent content)
        {
            ...
            // Parse the JSON into a CreateMessageRequest object
            using var document = JsonDocument.Parse(stream);
            return CreateRunRequest.DeserializeCreateRunRequest(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        private static CreateThreadAndRunRequest DeserializeCreateThreadAndRunRequest(RequestContent content)
        {
            ...
            // Parse the JSON into a CreateMessageRequest object
            using var document = JsonDocument.Parse(stream);
            return CreateThreadAndRunRequest.DeserializeCreateThreadAndRunRequest(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        private static SubmitToolOutputsToRunRequest DeserializeSubmitToolOutputsToRunRequest(RequestContent content)
        {
            ...
            // Parse the JSON into a CreateMessageRequest object
            using var document = JsonDocument.Parse(stream);
            return SubmitToolOutputsToRunRequest.DeserializeSubmitToolOutputsToRunRequest(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
            ...
            if (doc.RootElement.TryGetProperty("data", out JsonElement dataElement) && dataElement.ValueKind == JsonValueKind.Array)
            {
                foreach (JsonElement itemElement in dataElement.EnumerateArray())
                {
                    if (_scopeType == OpenTelemetryScopeType.ListMessages)
                    {
                        ...
                        PersistentThreadMessage message = PersistentThreadMessage.DeserializePersistentThreadMessage(itemElement, ModelSerializationExtensions.WireOptions);
                    ...
                    else if (_scopeType == OpenTelemetryScopeType.ListRunSteps)
                    {
                        ...
                        // Use your model's deserializer
                        RunStep runStep = RunStep.DeserializeRunStep(itemElement, ModelSerializationExtensions.WireOptions);
        ...
        public static IReadOnlyDictionary<string, string> GetToolCallAttributes(RunStepToolCall toolCall)
        {
            ...
            BinaryData toolCallData = ((IPersistableModel<RunStepToolCall>)toolCall).Write(ModelSerializationExtensions.WireOptions);
            using var tempDoc = JsonDocument.Parse(toolCallData);
