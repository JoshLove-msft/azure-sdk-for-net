            ...
            else
            {
                if (threadId is null)
                {
                    ...
                    CreateThreadRequest createThreadRequest = new(
                        ...
                        metadata: runOptions.Metadata != null ? (IDictionary<string, string>)runOptions.Metadata.ToDictionary(x => x.Key, x => x.Value) : new ChangeTrackingDictionary<string, string>(),
