...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetExceptionPoliciesCollectionResult : Pageable<BinaryData>
    {
        ...
        public JobRouterAdministrationClientGetExceptionPoliciesCollectionResult(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
