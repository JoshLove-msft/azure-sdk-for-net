...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetClassificationPoliciesCollectionResultOfT : Pageable<ClassificationPolicy>
    {
        ...
        public JobRouterAdministrationClientGetClassificationPoliciesCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<ClassificationPolicy>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ClassificationPolicy>.FromValues((IReadOnlyList<ClassificationPolicy>)result.Value, nextPage?.AbsoluteUri, response);
