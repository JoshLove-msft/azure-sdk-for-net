...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterClientGetWorkersCollectionResultOfT : Pageable<RouterWorker>
    {
        ...
        public JobRouterClientGetWorkersCollectionResultOfT(JobRouterClient client, int? maxpagesize, string state, string channelId, string queueId, bool? hasCapacity, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<RouterWorker>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<RouterWorker>.FromValues((IReadOnlyList<RouterWorker>)result.Value, nextPage?.AbsoluteUri, response);
