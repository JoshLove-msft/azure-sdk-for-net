...
namespace Microsoft.Extensions.Azure
{
    ...
    public static partial class CommunicationMessagesClientBuilderExtensions
    {
            ...
            where TBuilder : IAzureClientFactoryBuilderWithCredential
        {
            ...
            return builder.RegisterClientFactory<NotificationMessagesClient, CommunicationMessagesClientOptions>((options, credential) => new NotificationMessagesClient(endpoint, credential, options));
        }
            ...
            where TBuilder : IAzureClientFactoryBuilderWithCredential
        {
            ...
            return builder.RegisterClientFactory<MessageTemplateClient, CommunicationMessagesClientOptions>((options, credential) => new MessageTemplateClient(endpoint, credential, options));
        }
        ...
        public static IAzureClientBuilder<ConversationThreadClient, CommunicationMessagesClientOptions> AddConversationThreadClient<TBuilder>(this TBuilder builder, Uri endpoint, global::Azure.Communication.CommunicationTokenCredential communicationTokenCredential)
            where TBuilder : IAzureClientFactoryBuilder
        {
