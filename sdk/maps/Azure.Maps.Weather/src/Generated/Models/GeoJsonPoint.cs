...
namespace Azure.Maps.Weather
{
    ...
    public partial class GeoJsonPoint : GeoJsonGeometry
    {
        ...
        /// </param>
        internal GeoJsonPoint(IEnumerable<double> coordinates) : base(GeoJsonObjectType.GeoJsonPoint)
        {
        ...
        /// 7946](https://tools.ietf.org/html/rfc7946#section-3.1.1) for details.
        /// </param>
        internal GeoJsonPoint(GeoJsonObjectType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<double> coordinates) : base(@type, additionalBinaryDataProperties)
        {
