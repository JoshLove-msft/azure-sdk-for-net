...
namespace Azure.Maps.Weather
{
    internal static partial class GeoJsonObjectTypeExtensions
    {
        ...
        {
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Point"))
            {
                return GeoJsonObjectType.GeoJsonPoint;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "MultiPoint"))
            {
                return GeoJsonObjectType.GeoJsonMultiPoint;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "LineString"))
            {
                return GeoJsonObjectType.GeoJsonLineString;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "MultiLineString"))
            {
                return GeoJsonObjectType.GeoJsonMultiLineString;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "Polygon"))
            {
                return GeoJsonObjectType.GeoJsonPolygon;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "MultiPolygon"))
            {
                return GeoJsonObjectType.GeoJsonMultiPolygon;
            }
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "GeometryCollection"))
            {
            ...
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "FeatureCollection"))
            {
