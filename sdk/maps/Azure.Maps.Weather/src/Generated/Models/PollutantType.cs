...
{
    /// <summary> Specifies the six types of pollutants tracked by the Azure Maps Weather service. </summary>
    public readonly partial struct PollutantType : IEquatable<PollutantType>
    {
        ...
        /// <summary> Particulate matter 2.5. </summary>
        private const string PM25Value = "PM2.5";
        /// <summary> Particulate matter 10. </summary>
        ...
        /// <summary> Converts a string to a <see cref="PollutantType"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator PollutantType?(string value) => value == null ? null : new PollutantType(value);
